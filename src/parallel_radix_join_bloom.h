/**
 * @file    parallel_radix_join_bloom.h
 * @author  Cagri Balkesen <cagri.balkesen@inf.ethz.ch>
 * @date    Sun Feb 20:09:59 2012
 * @version $Id: parallel_radix_join_bloom.h 4419 2013-10-21 16:24:35Z bcagri $
 *
 * @brief  Provides interfaces for several variants of Radix Hash Join using Bloom Filters.
 *
 * (c) 2012, ETH Zurich, Systems Group
 *
 */

#ifndef PARALLEL_RADIX_JOIN_BLOOM_H
#define PARALLEL_RADIX_JOIN_BLOOM_H
...
#endif /* PARALLEL_RADIX_JOIN_BLOOM_H */
